...
from .utils import percentile_stretch, raw_rgb_for_visual, stack_bgrn
...
def process_directory(input_dir, output_dir):
    ...
    for prefix, band_files in groups.items():
        ...
        orig_rgb = raw_rgb_for_visual(b04, b03, b02)
        sr_rgb = percentile_stretch(
            np.stack([sr_u16[..., 2], sr_u16[..., 1], sr_u16[..., 0]], axis=-1)
        )
        comp_png = COMP_DIR / f"{prefix}_comparison.png"
        save_comparison_grid(orig_rgb, sr_rgb, comp_png)
